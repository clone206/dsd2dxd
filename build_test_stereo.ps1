...
Get-Content -AsByteStream -Raw $InputFile | .\target\debug\dsd2dxd -c 2 -f $Format -b $outBits -e $Endianness --level=$Level | ffplay -f "s${outBits}le" -ar 352.8k -ch_layout stereo -i -
